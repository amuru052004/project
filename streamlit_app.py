...
import pickle
import numpy as np
from sklearn.preprocessing import LabelEncoder # Keep this import as you might need it for other encoders if you decide to save them
...
if st.button("Predict Career"):
    ...
    st.success(f"Recommended Career ID: {prediction[0]}")
